...
1. In `product-alerts.component.ts`, import [`Output`](https://v17.angular.io/api/core/Output) and [`EventEmitter`](https://v17.angular.io/api/core/EventEmitter) from `@angular/core`.
...
2. In the component class, define a property named `notify` with an [`@Output()`](https://v17.angular.io/api/core/Output) decorator and an instance of [`EventEmitter()`](https://v17.angular.io/api/core/EventEmitter). Configuring `ProductAlertsComponent` with an [`@Output()`](https://v17.angular.io/api/core/Output) allows the `ProductAlertsComponent` to emit an event when the value of the `notify` property changes.
...
![alt text](product-alert-notification.png)

For more information on communication between components, see [Component Interaction](https://v17.angular.io/guide/component-interaction).
...
- Continue to [In-app navigation](https://v17.angular.io/start/start-routing) to create a product details page.
- Skip ahead to [Deployment](https://v17.angular.io/start/start-deployment) to move to local development, or deploy your application to Firebase or your own server.